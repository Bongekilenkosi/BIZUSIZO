# BIZUSIZO native-speaker review — isiNdebele

**Language:** isiNdebele (code: `nr`)
...
**What you are reviewing:** all isiNdebele content that a patient might read (Part 1 — WhatsApp messages) or that the system scans patient text for (Part 2 — clinical safety keywords).

---

## PART 1 — Patient-facing WhatsApp messages (51 entries)

Each row shows the English source text (for reference) and the current isiNdebele translation. If isiNdebele is marked **[MISSING — PLEASE TRANSLATE]**, the translation has not been written yet and we need you to provide it.
...
**isiNdebele:**
```
✅ Siyathokoza. Ake sikuqondise ekunakekelweni okufanele.
```
...
**isiNdebele:**
```
Kulungile. Iseshini yakho iphelile futhi akukho lwazi olugciniwe.
...
**isiNdebele:**
```
Yini ikinga yakho ekulu namhlanje?
...
**isiNdebele:**
```
Ngidinga ulwazi olunengi ukuhlola iimpawu zakho ngokunembe.
...
**isiNdebele:**
```
ℹ️ Sihlole iimpawu zakho, kodwana ukuqiniseka kwethu kuphansi kunokujayelekileko. Umphumela wakho usaboniswa ngaphezulu.
...
**isiNdebele:**
```
Ikliniki ivaliwe nje. Ya esibhedlela esiseduze — esigeni seziphuthumako.
```
...
**isiNdebele:**
```
Ungaya endaweni yokulatjhwa ngokuphepha?
...
**isiNdebele:**
```
⏰ Iinkliniki zivaliwe nje. Naku okufanele ukwenze:
...
**isiNdebele:**
```
Lotjha, usitjheje ku-BIZUSIZO emalangeni la-2 langaphambili. Iimpawu zakho zinjani?
1. Zincono ✅
2. Ziyafana ➡️
3. Zimbi khulu ⚠️
```
...
**isiNdebele:**
```
✅ Siyathaba kuthi uzizwa ncono. Akukho okhunye okutlhogekako. Hlala kuhle!
```
...
**isiNdebele:**
```
🟡 Ragela phambili uqale iimpawu zakho. Vakatjhela ikliniki uma zingabi ncono ngema-iri angu-24.
```
...
**isiNdebele:**
```
⚠️ Iimpawu zakho zingaba zimbi. Unesi utjhejisiwe. Uma kuphuthumako, ringela *10177* nje.
```
...
**isiNdebele:**
```
Umbuzo owodwa — ngabe uvakashele ikliniki ngemuva kokuhloliwa?
...
**isiNdebele:**
```
Ngiyabonga. Impendulo yakho isisiza ukuthuthukisa BIZUSIZO. Hlala kuhle. 🙏
```
...
**isiNdebele:**
```
📍 Sibawa wabelane nendawo yakho bona sithole indawo yokulatjhwa eseduze.
...
**isiNdebele:**
```
Ngaphambi kobana siragele phambili, uyawasela na imitjhi yobulwelibu? (Phendula ngenomboro, isib. "1,3" namkha "0" uma kungekho)
...
**isiNdebele:**
```
✅ Siyathokoza. Lokhu kusisiza sikunikele isinqophiso esingcono.
```
...
**isiNdebele:**
```
Ngubani ibizo lakho? (Njengoba libhaliwe ku-ID yakho)
...
**isiNdebele:**
```
Ilanga lakho lokubelethwa liyini?
...
**isiNdebele:**
```
(name, surname) => `✅ Siyathokoza, *${name} ${surname}*. Lokhu kusiza ikliniki ilungiselele ifayili yakho ungakafiki.`
```
...
**isiNdebele:**
```
📁 Kuhle — ikliniki izakufuna ifayili yakho ungakafiki.
```
...
**isiNdebele:**
```
🆕 Akukho ikinga — ikliniki izakwenza ifayili etja. Lokhu kusindisa isikhathi nawufika.
```
...
**isiNdebele:**
```
📋 Akukho ikinga. Ikliniki izakuhlola nawufika. Ibizo lakho nelanga lokubelethwa kuzabasiza bafumane ifayili yakho msinyana.
```
...
**isiNdebele:**
```
Uyahlanganyela na kurhubhululo lwe-BIZUSIZO ekliniki?
...
**isiNdebele:**
```
🎤 Ungathumela voice note uchaza iimpawu zakho. Khuluma kuhle usitjele:
...
**isiNdebele:**
```
🎤 Voice note itholakele. Angisebenze umlayezo wakho...
```
...
**isiNdebele:**
```
⚠️ Sinekinga yebuchwepheshe futhi asikghoni ukusebenza umlayezo wakho nje.
...
**isiNdebele:**
```
💊 Ukuthatha imitjhoga akukabi khona endaweni yakho. Sibawa uvakatjhele ikliniki eseduze ukuthatha imitjhoga.
```
...
**isiNdebele:**
```
✅ Kubonisana kwakho nge-video kubhukiwe. Uzakuthola umlayezo wokuqinisekisa nelusuku, isikhathi, nelinki ye-video.
```
...
**isiNdebele:**
```
📱 Kubhukhela kubonisana kwakho nge-video, sibawa uthumele umlayezo ku nomboro le nge-WhatsApp:\n\n*${phone}*\n\nBatjele kuthi BIZUSIZO ikurhumele futhi uchaze iimphawu zakho.
```
...
**isiNdebele:**
```
📱 Kubonisana nge-video akukabi khona endaweni yakho. Sibawa uvakatjhele ikliniki eseduze.
```
...
**isiNdebele:**
```
Ase ngihlole imiphumela yakho yasekhemisi. Umzuzwana owodwa...
```
...
**isiNdebele:**
```
Ukuhlolwa kwakho kwe-*${testType}* kwe-*${testDate}* kusentiwa. Sizakwazisa ku-WhatsApp ngemiphumela nayitholakala.\n\nAwudzingi ukuvakatjhela ikliniki ukuhlola — sizakuza kuwe.
```
...
The system scans patient text for keyword combinations and assigns a triage level (RED = emergency, ORANGE = very urgent, YELLOW = urgent) **independent of the AI**. Each rule below shows the English trigger phrases (so you know what the rule is for) and the current isiNdebele keywords the system recognises. These are natural patient phrasings, not clinical terminology.

**For each rule, please:**
1. Confirm the listed isiNdebele keywords are correct and natural for how a patient would type on WhatsApp.
...
**Current isiNdebele keywords** (what the rule recognises in isiNdebele):
- `ihliziyo yeme`
...
**Current isiNdebele keywords** (what the rule recognises in isiNdebele):
- **⚠️ NONE — please provide keywords for this symptom in isiNdebele**
