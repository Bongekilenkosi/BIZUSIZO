...
**Sesotho:**
```
(name, dist) => `📍 Lefelo le haufi: *${name}* (${dist} km).\n\nO ka fihla habonolo?\n1 — E\n2 — Tjhe, mpontshe tse ding`
```
...
**Sesotho:**
```
(firstName) => `Re a leboha, *${firstName}*.\n\nFane ya hao ke mang?\n\nNgola fane ya hao:`
```
...
**Sesotho:**
```
(name, surname) => `✅ Re a leboha, *${name} ${surname}*. Sena se thusa kliniki ho lokisetsa faele ya hao pele o fihla.`
```
