...
**Tshivenda:**
```
(name, surname) => `✅ Ri a livhuwa, *${name} ${surname}*. Izwi \u1e3di thusa kiliniki u lugisa faela yaṋu ni sa athu u swika.`
```
